...
from comfy_controlnet_preprocessors.v1.uniformer.mmcv.cnn import (build_conv_layer, build_norm_layer, constant_init,
                      kaiming_init)
...
from comfy_controlnet_preprocessors.v1.uniformer.mmseg.ops import Upsample, resize
...
class HRNet(nn.Module):
    ...
    Example:
        >>> from comfy_controlnet_preprocessors.v1.uniformer.mmseg.models import HRNet
        >>> import torch
        >>> extra = dict(
        >>>     stage1=dict(
        >>>         num_modules=1,
