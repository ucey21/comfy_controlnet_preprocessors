...
sleep(2)
os.system(f'pip install -r "{EXT_PATH}/requirements.txt" --upgrade --force-reinstal --extra-index-url https://download.pytorch.org/whl/cu117 --no-warn-script-location')
